...
folder.fastSimcoal2 <- "/home/carmelet/embo_popgen_2025/Me";

setwd(folder.fastSimcoal2);

#Simulte data with population substructure
...
plot(mds.result$points[,1:2], xlab = paste("DIM 1 (",round(100*mds.result$eig[1]/sum(mds.result$eig),2) ," %)"), ylab = paste("DIM 2 (",round(100*mds.result$eig[2]/sum(mds.result$eig),2) ," %)"),,main="30% admixture")
...
plot(mds.result$eig); 
# plot the result (nicer with ggplot2, of course)
plot(mds.result$points[,1:2], xlab = paste("DIM 1 (",round(100*mds.result$eig[1]/sum(mds.result$eig),2) ," %)"), ylab = paste("DIM 2 (",round(100*mds.result$eig[2]/sum(mds.result$eig),2) ," %)"),main="70% admixture")
points(mds.result$points[pop=="A",1], mds.result$points[pop=="A",2], pch = 19, col ="red");
points(mds.result$points[pop=="B",1], mds.result$points[pop=="B",2], pch = 19, col ="blue");
...
plot(mds.result$eig); 
# plot the result (nicer with ggplot2, of course)
plot(mds.result$points[,1:2], xlab = paste("DIM 1 (",round(100*mds.result$eig[1]/sum(mds.result$eig),2) ," %)"), ylab = paste("DIM 2 (",round(100*mds.result$eig[2]/sum(mds.result$eig),2) ," %)"),main="70% admixture and 100 generation since admixture")
points(mds.result$points[pop=="A",1], mds.result$points[pop=="A",2], pch = 19, col ="red");
points(mds.result$points[pop=="B",1], mds.result$points[pop=="B",2], pch = 19, col ="blue");
...
plot(mds.result$eig); 
# plot the result (nicer with ggplot2, of course)
plot(mds.result$points[,1:2], xlab = paste("DIM 1 (",round(100*mds.result$eig[1]/sum(mds.result$eig),2) ," %)"), ylab = paste("DIM 2 (",round(100*mds.result$eig[2]/sum(mds.result$eig),2) ," %)"),main="Split 500 generation")
points(mds.result$points[pop=="A",1], mds.result$points[pop=="A",2], pch = 19, col ="red");
points(mds.result$points[pop=="B",1], mds.result$points[pop=="B",2], pch = 19, col ="blue");
...
(extract.admixture(mds.result$points))
...
#The first PC indicate clearly the admixture proportion of the ancestral population 
...
#The variance of the admixture reduce with the time of admixture, 
#the population is separating itself from the ancestral population
